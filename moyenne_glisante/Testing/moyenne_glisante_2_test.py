...
# Import mock modules for testing on PC
from mock_modules import board, busio, analogio, np
...
# Function to SIMULATE ADC value, apply calibration, and convert to voltage and microns
def read_adc():
